...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { icon: Users, label: "Squad Finder", href: "/squads" },
    { icon: Trophy, label: "Tournaments", href: "/tournaments" },
    { icon: Activity, label: "Performance", href: "/analytics" },
  ...
  return (
    <aside
      className={`fixed left-0 top-0 h-screen bg-white border-r border-slate-100 transition-all duration-500 ease-in-out z-[100] flex flex-col ${
